...
for (const groupName in groups) {
    ...
    const niceName = groupName.split(/[\._]/)[0];
    outJSON[niceName] = localPositions;
}

fs.writeFileSync('c:\\Users\\rohin\\PhoneAI\\local-ai\\assets\\foxGeometry.json', JSON.stringify(outJSON));
console.log('Saved kitsuneGeometry.json!');
